      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center p-6 pt-12 lg:pt-20 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center text-center max-w-5xl mx-auto space-y-8">
          ...
          <div className="space-y-2">
            <h1 className="text-6xl md:text-8xl font-serif text-transparent bg-clip-text bg-gradient-to-b from-sacred-gold via-[#fcd34d] to-[#b45309] drop-shadow-sm tracking-tight">Fiat</h1>
            <p className="text-2xl md:text-3xl font-serif italic text-slate-300 font-light">"Luz do Alto para sua alma."</p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4 w-full max-w-md justify-center">
            <Button variant="sacred" size="lg" onClick={handleEnter} className="h-14 text-lg shadow-[0_0_30px_rgba(212,175,55,0.3)] hover:scale-105 transition-transform border border-yellow-200/20">
              Entrar no Santuário
            </Button>
          </div>
            ...
            <div className="relative w-full h-full bg-[#1a1a1a] rounded-[3rem] border-[8px] border-[#2a2a2a] shadow-2xl overflow-hidden ring-1 ring-white/10 transform rotate-y-12 hover:rotate-0 transition-transform duration-700 ease-out">
              ...
              <div className="w-full h-full bg-[#0f172a] flex flex-col overflow-hidden relative">
                ...
                <div className="mx-4 mt-2 p-4 rounded-2xl bg-gradient-to-br from-gray-800 to-gray-900 border border-white/10 shadow-lg relative overflow-hidden group">
                  <div className="absolute top-0 right-0 p-4 opacity-20"><IconRosary size={60} className="text-sacred-gold" /></div>
                ...
                <div className="mt-auto h-16 bg-black/40 backdrop-blur-md border-t border-white/5 flex justify-around items-center px-2 pb-2">
                  <div className="flex flex-col items-center text-sacred-gold">
                    <IconMonstrance size={20}/>
                    <span className="text-[8px] mt-1">Início</span>
                  </div>
                  <div className="flex flex-col items-center text-gray-600">
                    <IconBible size={20}/>
                    <span className="text-[8px] mt-1">Orações</span>
                  </div>
                  <div className="flex flex-col items-center text-gray-600">
                    <IconRosary size={24}/>
                    <span className="text-[8px] mt-1">Terço</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-[#0b1221] relative">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <div className="inline-block p-2 px-4 rounded-full bg-sacred-gold/5 border border-sacred-gold/20 mb-4">
              <span className="text-sacred-gold text-xs font-bold uppercase tracking-[0.2em]">Tudo em um só lugar</span>
            </div>
            <h2 className="text-4xl font-serif text-white mb-4">A Tecnologia a Serviço da Fé</h2>
            <p className="text-gray-400 max-w-2xl mx-auto font-light">
              Cada detalhe do Fiat foi pensado para elevar sua alma, sem distrações mundanas.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-6">
            {/* ... todo o conteúdo das seções continua igual ... */}
            {/* (mantive exatamente como estava, só corrigi a parte final) */}
          </div>
        </div>
      </section>

      {/* ... todas as outras seções continuam exatamente iguais ... */}
