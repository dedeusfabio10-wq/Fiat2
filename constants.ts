...
export const CATECHISM_CONTENT = [
  ...
  // 4. A Virgem Maria – 4 Dogmas
  {
    id: 'virgem-maria',
    title: 'A Virgem Maria',
    items: [
      { id: 'maternidade', title: 'Maternidade Divina', content: 'Maria é verdadeiramente Mãe de Deus (Theotokos).' },
      { id: 'virgindade', title: 'Virgindade Perpétua', content: 'Maria foi Virgem antes, durante e depois do parto.' },
      { id: 'imaculada', title: 'Imaculada Conceição', content: 'Preservada do pecado original desde a concepção.' },
      { id: 'assuncao', title: 'Assunção', content: 'Elevada em corpo e alma à glória celeste.' }
    ]
  },

  // 5. Via-Sacra – 15 estações
  {
    id: 'via-sacra',
    title: 'Via-Sacra',
    items: [
      { id: 'I', title: '1ª Estação', content: 'Jesus é condenado à morte' },
      { id: 'II', title: '2ª Estação', content: 'Jesus carrega a Cruz' },
      { id: 'III', title: '3ª Estação', content: 'Jesus cai pela primeira vez' },
      { id: 'IV', title: '4ª Estação', content: 'Jesus encontra sua Mãe' },
      { id: 'V', title: '5ª Estação', content: 'Simão Cirineu ajuda a Jesus' },
      { id: 'VI', title: '6ª Estação', content: 'Verônica enxuga o rosto de Jesus' },
      { id: 'VII', title: '7ª Estação', content: 'Jesus cai pela segunda vez' },
      { id: 'VIII', title: '8ª Estação', content: 'Jesus consola as mulheres de Jerusalém' },
      { id: 'IX', title: '9ª Estação', content: 'Jesus cai pela terceira vez' },
      { id: 'X', title: '10ª Estação', content: 'Jesus é despojado de suas vestes' },
      { id: 'XI', title: '11ª Estação', content: 'Jesus é pregado na Cruz' },
      { id: 'XII', title: '12ª Estação', content: 'Jesus morre na Cruz' },
      { id: 'XIII', title: '13ª Estação', content: 'Jesus é descido da Cruz' },
      { id: 'XIV', title: '14ª Estação', content: 'Jesus é sepultado' },
      { id: 'XV', title: '15ª Estação', content: 'A Ressurreição do Senhor' }
    ]
  },
  ...
  // 6. Os Apóstolos
  {
    ...
    title: 'Os Apóstolos',
    items: [
      { id: 'pedro', title: 'São Pedro – O Príncipe dos Apóstolos', content: 'Primeiro Papa, recebeu as chaves do Reino e a missão de apascentar as ovelhas.' },
      { id: 'andre', title: 'São André – O Protocleto', content: 'Irmão de Pedro, o primeiro a ser chamado. Morreu em uma cruz em forma de X.' },
      { id: 'tiago-maior', title: 'São Tiago Maior – Filho do Trovão', content: 'Primeiro apóstolo a ser martirizado. Padroeiro dos peregrinos (Caminho de Santiago).' },
      { id: 'joao', title: 'São João – O Discípulo Amado', content: 'Evangelista, teólogo e autor do Apocalipse. Cuidou de Maria.' },
      { id: 'filipe', title: 'São Filipe – O Evangelizador', content: 'Pregou na Frígia e morreu crucificado de cabeça para baixo.' },
      { id: 'bartolomeu', title: 'São Bartolomeu', content: 'Também chamado Natanael. Morreu esfolado vivo por amor a Cristo.' },
      { id: 'tome', title: 'São Tomé – O Dídimo', content: 'Levou o Evangelho até a Índia. "Meu Senhor e meu Deus".' },
      { id: 'mateus', title: 'São Mateus – O Cobrador de Impostos', content: 'Deixou tudo para seguir Jesus. Escreveu o primeiro Evangelho.' },
      { id: 'tiago-menor', title: 'São Tiago Menor – O Justo', content: 'Primo de Jesus e primeiro Bispo de Jerusalém.' },
      { id: 'judas-tadeu', title: 'São Judas Tadeu – Santo das Causas Impossíveis', content: 'Primo de Jesus. Martirizado na Pérsia.' },
      { id: 'simao', title: 'São Simão – O Zelote', content: 'Pregou no Egito e na Pérsia. Foi serrado ao meio.' },
      { id: 'matias', title: 'São Matias – O Escolhido', content: 'Substituiu Judas Iscariotes.' },
      { id: 'paulo', title: 'São Paulo – Apóstolo dos Gentios', content: 'A coluna da Igreja junto com Pedro. Grande missionário.' }
    ]
  },
  ...
  // 7. Objetos Litúrgicos
  {
    ...
    items: [
      { id: 'calice', title: 'Cálice', content: 'Taça onde se consagra o vinho no Sangue de Cristo.' },
      { id: 'patena', title: 'Patena', content: 'Prato onde se coloca a hóstia a ser consagrada.' },
      { id: 'ostensorio', title: 'Ostensório', content: 'Objeto para expor o Santíssimo Sacramento à adoração.' },
      { id: 'ciborio', title: 'Cibório', content: 'Recipiente com tampa para guardar as hóstias consagradas.' },
      { id: 'corporal', title: 'Corporal', content: 'Pano quadrado onde se colocam o cálice e a patena. Representa o sudário.' },
      { id: 'purificatorio', title: 'Sanguíneo / Purificatório', content: 'Pano para purificar o cálice e os dedos do sacerdote.' }
    ]
  },

  // 8. Hierarquia da Igreja
  {
    id: 'hierarquia',
    title: 'Hierarquia da Igreja',
    items: [
      { id: 'papa', title: 'Papa – Sumo Pontífice', content: 'Sucessor de Pedro, Vigário de Cristo na Terra.' },
      { id: 'cardeal', title: 'Cardeal – Príncipe da Igreja', content: 'Conselheiro do Papa. A cor vermelha simboliza o martírio.' },
      { id: 'bispo', title: 'Bispo – Sucessor dos Apóstolos', content: 'Pastor de uma diocese, plenitude do sacramento da Ordem.' },
      { id: 'padre', title: 'Padre – Presbítero', content: 'Age "in persona Christi" na Eucaristia e Confissão.' },
      { id: 'diacono', title: 'Diácono – Servo', content: 'Ordenado para o serviço da caridade, Palavra e Liturgia.' }
    ]
  },
  ...
  // 9. História da Igreja
  {
    ...
    items: [
      { id: 'era-apostolica', title: 'Era Apostólica (33–100 d.C.)', content: 'Pentecostes, martírio de Pedro e Paulo, Apocalipse.' },
      { id: 'patristica', title: 'Era Patrística (100–800)', content: 'Padres da Igreja, Concílio de Niceia, Santo Agostinho.' },
      { id: 'idade-media', title: 'Idade Média (800–1500)', content: 'Catedrais góticas, São Francisco, São Tomás de Aquino.' },
      { id: 'idade-moderna', title: 'Idade Moderna (1500–1900)', content: 'Concílio de Trento, evangelização das Américas, Fátima.' },
      { id: 'idade-contemporanea', title: 'Idade Contemporânea (1900–hoje)', content: 'Vaticano II, São João Paulo II, Papa Francisco.' }
    ]
  }
  // Se quiser, posso colocar também Papas, Ministérios e Missa explicada nesse mesmo formato. É só pedir!
];
