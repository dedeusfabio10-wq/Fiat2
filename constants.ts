...
export const SAINTS: Saint[] = [
  ...
  { id: 'sao-jose', name: 'São José', title: 'Patrono Universal da Igreja', date: '19 de Março', bio: 'Esposo da Virgem Maria e pai adotivo de Jesus.', prayer: 'Ó São José, cujo poder se estende a todas as necessidades...' },
  { id: 'santa-teresinha', name: 'Santa Teresinha do Menino Jesus', title: 'Doutora da Igreja', date: '01 de Outubro', bio: 'Ensina a Pequena Via da infância espiritual.', prayer: 'Santa Teresinha, rogai por nós que recorremos a vós.' },
  { id: 'sao-francisco-assis', name: 'São Francisco de Assis', title: 'Pobrezinho de Deus', date: '04 de Outubro', bio: 'Fundador dos Franciscanos, amante da criação.', prayer: 'Senhor, fazei-me instrumento de vossa paz...' },
  { id: 'sao-bento', name: 'São Bento', title: 'Pai do Monaquismo Ocidental', date: '11 de Julho', bio: 'Fundador da Ordem Beneditina.', prayer: 'A Cruz sagrada seja a minha luz...' },
  { id: 'padre-pio', name: 'São Pio de Pietrelcina', title: 'Padre estigmatizado', date: '23 de Setembro', bio: 'Carregou os estigmas de Cristo por 50 anos.', prayer: 'Fica, Senhor, comigo...' },
  { id: 'santa-rita', name: 'Santa Rita de Cássia', title: 'Santa das Causas Impossíveis', date: '22 de Maio', bio: 'Esposa, mãe e monja, exemplo de perdão.', prayer: 'Ó poderosa Santa Rita, advogada dos casos desesperados...' },
  { id: 'santo-antonio', name: 'Santo Antônio de Pádua', title: 'Martelo dos Hereges', date: '13 de Junho', bio: 'Grande pregador e doutor da Igreja.', prayer: 'Se milagres desejais, recorrei a Santo Antônio...' },
  { id: 'sao-judas-tadeu', name: 'São Judas Tadeu', title: 'Apóstolo das Causas Desesperadas', date: '28 de Outubro', bio: 'Primo de Jesus, apóstolo e mártir.', prayer: 'São Judas Tadeu, rogai por nós nas causas difíceis.' },
  { id: 'santa-faustina', name: 'Santa Faustina Kowalska', title: 'Apóstola da Divina Misericórdia', date: '05 de Outubro', bio: 'Recebeu as revelações da Divina Misericórdia.', prayer: 'Jesus, eu confio em Vós!' },
  { id: 'carlo-acutis', name: 'Beato Carlo Acutis', title: 'Apóstolo da Eucaristia', date: '12 de Outubro', bio: 'Jovem apaixonado pela Eucaristia.', prayer: 'A Eucaristia é minha autoestrada para o céu.' },

  { id: 'nossa-senhora-aparecida', name: 'Nossa Senhora Aparecida', title: 'Padroeira do Brasil', date: '12 de Outubro', bio: 'Rainha e Padroeira do Brasil.', prayer: 'Ó incomparável Senhora da Conceição Aparecida...' },
  { id: 'nossa-senhora-fatima', name: 'Nossa Senhora de Fátima', title: 'Rainha do Rosário', date: '13 de Maio', bio: 'Apareceu aos três pastorinhos em 1917.', prayer: 'Ó Virgem Santíssima, Mãe de Deus e nossa Mãe...' },
  { id: 'nossa-senhora-guadalupe', name: 'Nossa Senhora de Guadalupe', title: 'Imperatriz da América', date: '12 de Dezembro', bio: 'Apareceu a São Juan Diego.', prayer: 'Santa Maria de Guadalupe, Mãe e Rainha...' },
  { id: 'nossa-senhora-lourdes', name: 'Nossa Senhora de Lourdes', title: 'Imaculada Conceição', date: '11 de Fevereiro', bio: 'Apareceu 18 vezes a Santa Bernadette.', prayer: 'Ó Virgem Imaculada de Lourdes, curai-nos...' },
  { id: 'santa-monica', name: 'Santa Mônica', title: 'Mãe de Santo Agostinho', date: '27 de Agosto', bio: 'Exemplo de mãe que reza pelos filhos.', prayer: 'Santa Mônica, modelo de mãe cristã, rogai por nós.' },
  { id: 'santo-agostinho', name: 'Santo Agostinho', title: 'Doutor da Graça', date: '28 de Agosto', bio: 'Bispo e grande teólogo.', prayer: 'Tarde Vos amei, ó Beleza tão antiga e tão nova...' },
  { id: 'sao-domingos-gusmao', name: 'São Domingos de Gusmão', title: 'Fundador dos Dominicanos', date: '08 de Agosto', bio: 'Recebeu o Rosário das mãos de Maria.', prayer: 'São Domingos, pregador da verdade, rogai por nós.' },
  { id: 'santa-catarina-siena', name: 'Santa Catarina de Sena', title: 'Doutora da Igreja', date: '29 de Abril', bio: 'Mística e conselheira de papas.', prayer: 'Ó Catarina, fogo de amor divino, intercedei por nós.' },
  { id: 'sao-tomas-aquino', name: 'São Tomás de Aquino', title: 'Doutor Angélico', date: '28 de Janeiro', bio: 'Maior teólogo da história da Igreja.', prayer: 'Concedei-nos, Senhor, uma fé viva...' },
  { id: 'sao-joao-bosco', name: 'São João Bosco', title: 'Pai e Mestre da Juventude', date: '31 de Janeiro', bio: 'Fundador dos Salesianos.', prayer: 'São João Bosco, protegei a juventude.' },
  { id: 'santa-clara', name: 'Santa Clara de Assis', title: 'Fundadora das Clarissas', date: '11 de Agosto', bio: 'Seguiu São Francisco na pobreza radical.', prayer: 'Santa Clara, esposa de Cristo pobre...' },
  { id: 'sao-vicente-paul', name: 'São Vicente de Paulo', title: 'Pai dos Pobres', date: '27 de Setembro', bio: 'Fundador das Filhas da Caridade.', prayer: 'São Vicente, ensinai-nos a servir os pobres.' },
  { id: 'sao-camilo', name: 'São Camilo de Lellis', title: 'Padroeiro dos Enfermos', date: '14 de Julho', bio: 'Fundador dos Camilianos.', prayer: 'São Camilo, consolador dos doentes...' },
  { id: 'sao-joao-paulo-ii', name: 'São João Paulo II', title: 'O Papa da Família', date: '22 de Outubro', bio: 'Papa peregrino que guiou a Igreja no século XX.', prayer: 'Totus Tuus, Maria!' },
  { id: 'santa-gema', name: 'Santa Gema Galgani', title: 'Alma vítima', date: '11 de Abril', bio: 'Mística estigmatizada italiana.', prayer: 'Santa Gema, vítima de amor, rogai por nós.' },
  { id: 'sao-charbel', name: 'São Charbel Makhlouf', title: 'Eremita do Líbano', date: '24 de Julho', bio: 'Monge maronita famoso por milagres.', prayer: 'São Charbel, homem de Deus, intercedei por nós.' },
  { id: 'santa-filomena', name: 'Santa Filomena', title: 'Poderosa com Deus', date: '11 de Agosto', bio: 'Mártir virgem do século IV.', prayer: 'Santa Filomena, poderosa junto a Deus...' },
  { id: 'sao-cristovao', name: 'São Cristóvão', title: 'Padroeiro dos Motoristas', date: '25 de Julho', bio: 'Carregou o Menino Jesus nos ombros.', prayer: 'São Cristóvão, protegei-nos nas viagens.' },
  { id: 'sao-sebastiao', name: 'São Sebastião', title: 'Mártir das flechas', date: '20 de Janeiro', bio: 'Soldado romano martirizado.', prayer: 'São Sebastião, valente soldado de Cristo...' },
  { id: 'santa-lucia', name: 'Santa Lúcia', title: 'Virgem e Mártir', date: '13 de Dezembro', bio: 'Arrancaram-lhe os olhos por amor a Cristo.', prayer: 'Santa Lúcia, luz dos olhos e da fé...' },
  { id: 'santa-agnes', name: 'Santa Inês', title: 'Virgem e Mártir', date: '21 de Janeiro', bio: 'Morreu com 13 anos por amor a Jesus.', prayer: 'Santa Inês, lírio de pureza...' },
  { id: 'sao-lourenco', name: 'São Lourenço', title: 'Diácono e Mártir', date: '10 de Agosto', bio: 'Morreu assado numa grelha.', prayer: 'São Lourenço, mártir da caridade...' },
  { id: 'sao-bartolomeu', name: 'São Bartolomeu', title: 'Apóstolo esfolado vivo', date: '24 de Agosto', bio: 'Um dos 12 apóstolos.', prayer: 'São Bartolomeu, apóstolo fiel...' },
  { id: 'santa-edwiges', name: 'Santa Edwiges', title: 'Protetora dos Endividados', date: '16 de Outubro', bio: 'Rainha que ajudava os pobres.', prayer: 'Santa Edwiges, alívio dos endividados...' },
  { id: 'santa-catarina-laboure', name: 'Santa Catarina Labouré', title: 'Vidente da Medalha Milagrosa', date: '28 de Novembro', bio: 'Recebeu a Medalha Milagrosa.', prayer: 'Ó Maria concebida sem pecado...' },
  { id: 'sao-martinho', name: 'São Martinho de Tours', title: 'Soldado de Cristo', date: '11 de Novembro', bio: 'Dividiu a capa com um pobre.', prayer: 'São Martinho, exemplo de caridade...' },
  { id: 'santa-cecilia', name: 'Santa Cecília', title: 'Padroeira dos Músicos', date: '22 de Novembro', bio: 'Cantava a Deus no coração.', prayer: 'Santa Cecília, harmonia do céu...' },
  { id: 'sao-nicolau', name: 'São Nicolau', title: 'O verdadeiro Papai Noel', date: '06 de Dezembro', bio: 'Bispo famoso pela caridade.', prayer: 'São Nicolau, protetor das crianças...' },
  { id: 'santa-barbara', name: 'Santa Bárbara', title: 'Protetora contra raios', date: '04 de Dezembro', bio: 'Mártir do século III.', prayer: 'Santa Bárbara, livrai-nos dos trovões...' },
  { id: 'santo-inacio', name: 'Santo Inácio de Loyola', title: 'Fundador dos Jesuítas', date: '31 de Julho', bio: 'Ad maiorem Dei gloriam.', prayer: 'Tomai, Senhor, e recebei...' },
  { id: 'santa-teresa-avila', name: 'Santa Teresa de Ávila', title: 'Doutora da Igreja', date: '15 de Outubro', bio: 'Reformadora do Carmelo.', prayer: 'Nada te turbe, nada te espante...' },
  { id: 'sao-joao-da-cruz', name: 'São João da Cruz', title: 'Doutor Místico', date: '14 de Dezembro', bio: 'Mestre da noite escura da alma.', prayer: 'Ó chama de amor viva...' },
  { id: 'santa-maria-madalena', name: 'Santa Maria Madalena', title: 'Apóstola dos Apóstolos', date: '22 de Julho', bio: 'Primeira testemunha da Ressurreição.', prayer: 'Santa Maria Madalena, rogai por nós.' },
  { id: 'sao-maximiliano-kolbe', name: 'São Maximiliano Kolbe', title: 'Mártir de Auschwitz', date: '14 de Agosto', bio: 'Ofereceu-se no lugar de um pai de família.', prayer: 'Ó Imaculada, rainha do céu e da terra...' },
  { id: 'madre-teresa', name: 'Santa Teresa de Calcutá', title: 'Mãe dos mais pobres', date: '05 de Setembro', bio: 'Fundadora das Missionárias da Caridade.', prayer: 'Santa Teresa de Calcutá, ensinai-nos a amar os pobres.' },
  { id: 'beato-carlo-acutis', name: 'Beato Carlo Acutis', title: 'Apóstolo da Internet', date: '12 de Outubro', bio: 'Jovem italiano apaixonado pela Eucaristia.', prayer: 'A Eucaristia é minha autoestrada para o céu.' },
  { id: 'santa-gianna', name: 'Santa Gianna Beretta Molla', title: 'Mãe que deu a vida', date: '28 de Abril', bio: 'Escolheu salvar o filho em vez de si mesma.', prayer: 'Santa Gianna, modelo de mãe cristã...' },
  { id: 'sao-josemaria', name: 'São Josemaría Escrivá', title: 'Apóstolo da santidade no trabalho', date: '26 de Junho', bio: 'Fundador do Opus Dei.', prayer: 'Que eu veja com teus olhos, Cristo...' },
  { id: 'santa-margarida-alacoque', name: 'Santa Margarida Maria Alacoque', title: 'Apóstola do Sagrado Coração', date: '16 de Outubro', bio: 'Recebeu as promessas do Sagrado Coração.', prayer: 'Sagrado Coração de Jesus, eu confio em Vós.' },
  { id: 'sao-gerardo', name: 'São Gerardo Majella', title: 'Padroeiro das grávidas', date: '16 de Outubro', bio: 'Redentorista famoso por milagres com mães.', prayer: 'São Gerardo, protetor das mães...' },
  { id: 'sao-blas', name: 'São Brás', title: 'Protetor da garganta', date: '03 de Fevereiro', bio: 'Bispo e mártir.', prayer: 'Pela intercessão de São Brás, livrai-nos, Senhor...' },
  { id: 'santa-apollonia', name: 'Santa Apolônia', title: 'Protetora dos dentes', date: '09 de Fevereiro', bio: 'Arrancaram-lhe os dentes antes do martírio.', prayer: 'Santa Apolônia, aliviai nossas dores...' },
  { id: 'sao-valentim', name: 'São Valentim', title: 'Mártir do amor casto', date: '14 de Fevereiro', bio: 'Casava casais cristãos em segredo.', prayer: 'São Valentim, abençoai os namorados...' }
];
